...
public class OperatorGUI extends JFrame {
    ...
    public OperatorGUI(Operator operator){
        ...
        updateMenu.addActionListener(e -> {
            ...
            UpdatePatikaGUI updateGUI = new UpdatePatikaGUI(PatikaKlonu.Model.Patika.getFetch(select_id));
        ...
        deleteMenu.addActionListener(e -> {
            if (Helper.confirm("sure")){
                int select_id = Integer.parseInt(tbl_patika_list.getValueAt(tbl_patika_list.getSelectedRow(),0).toString());
                if(PatikaKlonu.Model.Patika.delete(select_id)){
                    Helper.showMsg("done");
                    loadPatikaModel();
                    loadPatikaCombo();
                }else {
        ...
        JMenuItem upMenu = new JMenuItem("Güncelle");
        JMenuItem delMenu = new JMenuItem("Sil");
        courseMenu.add(upMenu);
        courseMenu.add(upMenu);
        ...
        btn_patika_add.addActionListener(e -> {
            if (Helper.isFieldEmpty(fld_patika_name)){
                ...
                if(PatikaKlonu.Model.Patika.add(fld_patika_name.getText())){
                    Helper.showMsg("done");
                    loadPatikaModel();
                    loadPatikaCombo();
        ...
        btn_course_add.addActionListener(e -> {
            ...
            if (Helper.isFieldEmpty(fld_course_lang) || Helper.isFieldEmpty(fld_course_lang)){
                Helper.showMsg("fill");
            }else{
    ...
    private void loadPatikaModel() {
        ...
        clearModel.setRowCount(0);
        int i = 0;
        for(Patika obj : PatikaKlonu.Model.Patika.getList()){
            i=0;
